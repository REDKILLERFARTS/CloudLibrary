package net.cloud.library.commands;
...
public abstract class CloudCommandBuilder extends BukkitCommand implements Cloneable {
    ...
    public boolean register() {
        try {
            ...
            commandMap.register(getName(), CloudLibrary.getLibrary().getDescription().getName(), this);
    ...
    public CloudCommandBuilder getClonedCommand() {
        try {
            ...
            e.printStackTrace();
            CloudLibrary.getLibrary().getLogger().info("An error occured while cloning a command. (" + getName() + ")");
        }
        return null;
    }
